...
import { getTodos } from '../core/helper/coreapicalls';
import { deleteTodo } from './helper/userapicall';



const ManageAdminTodos = () => {
    ...
    return (
      <Base title="Welcome User" description="Manage todos here">
        <h2 className="mb-4">All Todos</h2>
...
export default ManageAdminTodos;